...
SECRET_KEY = 'django-insecure-9vrs(d(*!^55dx0jxf_p-se+pdp6o+%ntty%6*$s)-0t_uicl*'
...
ALLOWED_HOSTS = [
    ...
    '127.0.0.1', 
    '0.0.0.0',
    # Network addresses for development
    '172.19.2.144',
    '10.33.186.99',
    '172.31.64.1',
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:5173",
    # Network addresses for development
    "http://172.19.2.144:3000",
    "http://10.33.186.99:3000",
...
# Additional CORS settings for network development
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
